...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> booksByPriceLessThanFiveOrHigherThanForty(BigDecimal lower, BigDecimal upper) {
    ...
    @Override
    public List<String> findAllByReleaseDateNotIn(int year) {
    ...
    @Override
    public List<String> findAllByReleasedDateBefore(LocalDate date) {
